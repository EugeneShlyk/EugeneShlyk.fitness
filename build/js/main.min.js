...
var _posterVideo = require("./modules/poster-video.js");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    (0, _video.videoWork)();
    (0, _posterVideo.changePoster)();
  });
});

},{"./modules/form-validate/form":3,"./modules/poster-video.js":9,"./modules/slider-comments.js":10,"./modules/slider.js":11,"./modules/subscription.js":12,"./modules/video.js":13,"./modules/work-accordion.js":14,"./modules/work-tabs.js":15,"./utils/ios-vh-fix":17}],2:[function(require,module,exports){
"use strict";
...
exports.changePoster = void 0;
var video = document.querySelector('.gym__video');
var changePoster = function changePoster() {
...
exports.videoWork = void 0;
var video = document.querySelector('.gym__video');
var button = document.querySelector('.gym__inner-video-button');
var videoButtonHandler = function videoButtonHandler() {
  if (video.paused) {
    video.play();
...
var videoOnclick = function videoOnclick() {
  video.pause();
  button.style.display = 'block';
};
var videoWork = function videoWork() {
  if (video) {
    video.addEventListener('click', videoOnclick);
    button.addEventListener('click', videoButtonHandler);
  }
};
exports.videoWork = videoWork;
