...
var _workTabs = require("./modules/work-tabs.js");
var _workAccordion = require("./modules/work-accordion.js");
var _sliderComments = require("./modules/slider-comments.js");
var _video = require("./modules/video.js");
var _subscription = require("./modules/subscription.js");
var _validator = require("./modules/form-validate/validator.js");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    (0, _slider.workSlider)();
    (0, _workTabs.workTabs)();
    (0, _workAccordion.workAccordion)();
    (0, _sliderComments.workSliderComments)();
    (0, _video.findVideos)();
  });
});
...
},{"./modules/form-validate/form":3,"./modules/form-validate/validator.js":8,"./modules/modals/init-modals":9,"./modules/slider-comments.js":11,"./modules/slider.js":12,"./modules/subscription.js":13,"./modules/video.js":14,"./modules/work-accordion.js":15,"./modules/work-tabs.js":16,"./utils/ios-vh-fix":19}],2:[function(require,module,exports){
"use strict";
...
},{"../../utils/focus-lock":17,"../../utils/scroll-lock":20}],11:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.workSliderComments = void 0;
var sliderBox = document.querySelector('.comments__inner');
var Swiper = window.Swiper;
var workSliderComments = function workSliderComments() {
  return sliderBox && new Swiper('.swiper2', {
    navigation: {
...
exports.workSliderComments = workSliderComments;
...
exports.workSlider = void 0;
var sliderWrapper = document.querySelector('.slider-wrapper');
var Swiper = window.Swiper;
var workSlider = function workSlider() {
  return sliderWrapper && new Swiper('.swiper1', {
    navigation: {
...
var tabsButtons = document.querySelectorAll('.months-list__item-button');
  ...
  if (tabsButtons) {
    ...
    tabsButtons.forEach(function (btn) {
      ...
      btn.addEventListener('click', function () {
        ...
        var prevActiveButton = document.querySelector('.months-list__item-button--current');
        // Получаем предыдущую активную вкладку
        var prevActiveItem = document.querySelector('.program--active');
        ...
        var nextActiveItemId = "#".concat(btn.getAttribute('data-tab'));
        // получаем новую активную вкладку по id
        var nextActiveItem = document.querySelector(nextActiveItemId);
...
var videoWrapper = document.querySelector('.gym__inner-video-wrapper');
function findVideos() {
  if (videoWrapper) {
    var videos = document.querySelectorAll('.gym__inner-video-wrapper');
...
function setupVideo(video) {
  ...
  var media = video.querySelector('.gym__video-image');
  var button = video.querySelector('.gym__inner-video-button');
...
exports.workAccordion = void 0;
var boxes = Array.from(document.querySelectorAll('.accordion__item')); // считываем все элементы аккордеона в массив

var workAccordion = function workAccordion() {
  boxes.forEach(function (box) {
    var boxButton = box.querySelector('.accordion__item-inner-for-button');
    // добавляем обработчик событий
    boxButton.addEventListener('click', function (evt) {
      evt.preventDefault(); // сбрасываем стандартное поведение
      var currentBox = evt.target.closest('.accordion__item'); // определяем текущий бокс
      var currentContent = currentBox.querySelector('p'); // находим скрытый контент
...
exports.workAccordion = workAccordion;
...
exports.workTabs = void 0;
// получаем все кнопки навигации
var tabsButtons = document.querySelectorAll('.faq-category__item-button');
var workTabs = function workTabs() {
  if (tabsButtons) {
    // Проходимся по всем кнопкам
    tabsButtons.forEach(function (btn) {
      // вешаем на каждую кнопку обработчик события клик
      btn.addEventListener('click', function () {
        // Получаем предыдущую активную кнопку
        var prevActiveButton = document.querySelector('.faq-category__item-button--active');
        // Получаем предыдущую активную вкладку
        var prevActiveItem = document.querySelector('.accordion--active');
